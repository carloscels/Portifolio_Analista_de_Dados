      ...
      <div className='flex flex-col w-full max-w-[700px]'>
        <motion.h2
         ...
         className='h2 text-center mb-12'>
          Deixe sua 
          <span className='text-accent'> Mensagem.</span>
        </motion.h2>
        <motion.form
         ...
         className='flex-1 flex flex-col gap-6 w-full mx-auto'>
          ...
          <textarea placeholder='Escreva sua mensagem.' className='input'></textarea>
          <button className='bnt rounded-full border border-white/50 max-w-[170px] px-8
          transition-all duration-300 flex items-center justify-center overflow-hidden
          hover:border-accent group'>
            <span className='group-hover:-translate-y-[120%] group-hover:opacity-0 
            transition-all duration-300'>Enviar</span>
